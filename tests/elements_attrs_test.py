...
class TestElementAttrs():
  ...
  def test_hidden(self) -> None:
    assert Element(hidden=True).render_attrs() == 'hidden'
...
class TestHtmlAttrs():
  def test_xmlns(self) -> None:
    assert Html(xmlns='http://www.w3.org/1999/xhtml').render_attrs() == 'xmlns="http://www.w3.org/1999/xhtml"'
...
class TestObjectAttrs():
  def test_data(self) -> None:
    assert Object(data_='www.foo.bar/baz/?quux="1"').render_attrs() == 'data="www.foo.bar/baz/?quux=&quot;1&quot;"'
